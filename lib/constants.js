...
export const SPRINT_PHASES = [
  { key: "foundation", label: "Foundation", weeks: "1–4", target: "20 raw concepts", targetCount: 20, color: "#f59e0b", icon: "◈" },
  { key: "validation", label: "Validation", weeks: "5–12", target: "10 validated ideas", targetCount: 10, color: "#3b82f6", icon: "◉" },
  { key: "filing", label: "Filing", weeks: "13–30", target: "5 filed patents", targetCount: 5, color: "#10b981", icon: "▶" },
];
