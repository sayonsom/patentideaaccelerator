    ...
    <div>
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center gap-2">
          <Link
            href="/teams/join"
            className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-md border border-border text-ink text-sm font-medium hover:bg-neutral-off-white transition-colors"
          >
            <svg
              className="w-4 h-4"
              fill="none"
